...
import liuliu.custom.method.cube.app.CubeFragment;
...
import liuliu.custom.method.cube.concurent.SimpleTask;
...
import liuliu.custom.method.cube.image.iface.ImageLoadProgressHandler;
...
/**
 * Created by liuliu on 2015/11/27   15:03
 *
 * @author 柳伟杰
...
public class ImageLoader implements LifeCycleComponent {
    ...
    public void recoverWork() {
        ...
        mExitTasksEarly = false;
        setPause(false);
        Iterator<Map.Entry<String, LoadImageTask>> it = (Iterator<Map.Entry<String, LoadImageTask>>) mLoadWorkList.entrySet().iterator();
        while (it.hasNext()) {
