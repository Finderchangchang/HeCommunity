...
import liuliu.custom.method.cube.cache.DiskFileUtils;
import liuliu.custom.method.cube.image.iface.ImageDownloader;
import liuliu.custom.method.cube.image.iface.ImageLoadHandler;
import liuliu.custom.method.cube.image.iface.ImageMemoryCache;
import liuliu.custom.method.cube.image.iface.ImageReSizer;
import liuliu.custom.method.cube.image.iface.ImageTaskExecutor;
import liuliu.custom.method.cube.image.iface.NameGenerator;
import liuliu.custom.method.cube.image.impl.DefaultImageLoadHandler;
import liuliu.custom.method.cube.image.impl.DefaultImageReSizer;
import liuliu.custom.method.cube.image.impl.DefaultImageTaskExecutor;
import liuliu.custom.method.cube.image.impl.DefaultMemoryCache;
import liuliu.custom.method.cube.image.impl.DefaultNameGenerator;

/**
 * Created by liuliu on 2015/11/27   15:00
 *
 * @author 柳伟杰
