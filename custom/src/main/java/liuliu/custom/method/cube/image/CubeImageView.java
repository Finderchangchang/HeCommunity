...
import liuliu.custom.method.cube.image.drawable.RecyclingBitmapDrawable;
...
public class CubeImageView extends ImageView {
    ...
    private void tryLoadImage() {
        ...
        boolean isFullyWrapContent = lyp != null && lyp.height == ViewGroup.LayoutParams.WRAP_CONTENT && lyp.width == ViewGroup.LayoutParams.WRAP_CONTENT;
